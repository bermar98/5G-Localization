...
import numpy as np
from ml.predict_light_Zeitstempel import PositionEstimator

BASE_DIR = Path(__file__).resolve().parent
DATA_PATH = BASE_DIR / "data"
RESULTS_FILE = DATA_PATH / "Positionsvergleich/Messungen/position_comparisons_Zeitstempel.json"
...
class PositionComparator:
    ...
    def compare(self, record):
        ...
        estimated_pos = self.estimator.estimate(record["fingerprint"], record.get("timestamp"))
