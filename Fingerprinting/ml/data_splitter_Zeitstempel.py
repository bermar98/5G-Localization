...
def split_and_save(data, test_size=0.2, random_state=42, use_presence_feature=True, use_time_feature=True):

    # Feature-Vektoren bauen
    X, y, all_bssids = DatasetBuilder.build_dataset(
        data,
    ...
    print(f"Feature-Dimension: {X_train.shape[1]} "
          ...
          f"{'mit' if use_time_feature else 'ohne'} Zeitstempel-Feature, "
